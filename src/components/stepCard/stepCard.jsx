...
import Check from "../../assets/images/steps/checkmark.webp";

export const StepCard = ({currentStep}) => {
    return (
        <div className="step-card">
            <h4 className="step_card_title_container">
                <img loading="lazy"  src={Check} alt="Check" className="check_step_image" />
            ...
            <TelegramRedirect>
                <img loading="lazy"  src={currentStep.img} alt="step img" className="card_img_content_step" />
            </TelegramRedirect>
        </div>
    );
};
