...
import Img1MAN from "../../assets/images/img1-man.webp";
import Img1WOMAN from "../../assets/images/img1-woman.webp";
import Img2 from "../../assets/images/img1-2.webp";
...
import cheque from "../../assets/images/cheque.webp";
...
export const FirstContent = () => {
  ...
  return (
    <article className="first_content">
      ...
      <TelegramRedirect>
        <img width="720" height="118" src={Banner} alt="banner" className="image_responsive" />
      </TelegramRedirect>
      
      <div className="image_group">
        <TelegramRedirect>
          <img  src={Img1MAN} width="360" height="480" alt="Img2" className="image_responsive" />
        </TelegramRedirect>
        <TelegramRedirect>
          <img  src={Img1WOMAN} width="360" height="480" alt="Img2" className="image_responsive" />
        </TelegramRedirect>
      </div>
      ...
      {
        scrollPercentage.toFixed(2) > 2 ? (
          <>
            <div className="image_group">
              <TelegramRedirect>
                <img loading="lazy" width="720" height="451" src={Img2} alt="Img2" className="image_responsive" />
              </TelegramRedirect>
            </div>
            <p className="text_general_content">
            ...
            <img loading="lazy"  src={Img3} width="720" height="480" alt="Img3" className="image_responsive" />
            <h2 className="first_content_title">
            ...
            <TelegramRedirect>
              <img loading="lazy" width="720" height="450" src={Bill} alt="bill" className="image_responsive" />
            </TelegramRedirect>
            {/* add button here */}
              ...
              <>
                ...
                <p className="text_general_content">
                  <em>
                    ...
                    solução que as pessoas estavam esperando. Nunca na história
                    tivemos uma
                ...
                <p>
                  <TelegramRedirect>
                    <img loading="lazy"  src={Img5} alt="" className="image_responsive" />
                  </TelegramRedirect>
                </p>
                <p className="text_image_below">
                ...
                <h2 className="first_content_title">
                  <TelegramRedirect className="first_content_title_link_h2 title_blue">
                    A THE {OFFER_NAME.toUpperCase()} REALMENTE FUNCIONA? NÓS TESTAMOS
                    NÓS MESMOS
                  </TelegramRedirect>
                </h2>
                <p className="text_general_content">
                  ...
                  corporativa não queria que lançássemos qualquer informação que
                  pudesse potencialmente causar com que cidadãos Português perdessem
                  seu dinheiro suado.
                </p>
                <p className="text_general_content">
                ...
                <p className="text_general_content">
                  Gustavo tem 47 anos e é pai de 2 filhos. Sua esposa perdeu seu
                  trabalho ano passado devido à uma doença. Ele admitiu que estava
                  sofrendo financeiramente e essa oportunidade de investimento poderia
                  ser a resposta.
                </p>
                <p className="text_general_content">
                  
                  <TelegramRedirect>
                    <img loading="lazy"  src={Family} alt="family" className="image_responsive" />
                  </TelegramRedirect>
      
                </p>
                <p className="text_image_below">
                  A família de Gustavo estava sofrendo para conseguir ajustar as
                  contas e esperava que a{" "}
                  <TelegramRedirect className="general_links general_links_bold">
                    {" "}
                    {OFFER_NAME}
                  </TelegramRedirect>{" "}
                  pudesse aliviar sua pressão financeira, então decidiu testar o
                  sistema e relatar os resultados
                </p>
                <p className="text_general_content">
                  <b>Gustavo relata:</b>
                </p>
                ...
                <p className="text_general_content">
                  <em>
                    ...
                    quando eu me cadastrei. O vídeo parecia estar prometendo demais,
                    mas deixei meu ceticismo de lado. Em algumas horas, recebi uma
                    ligação do meu investidor pessoal. Ele respondeu todas as minhas
                    perguntas e tirou todas minhas dúvidas, e me garantiu que eu
                    ganharia dinheiro. Ponto.
                  </em>
                </p>
                <p className="text_general_content">
                  <em>
                    Meu investidor pessoal até me prometeu{" "}
                    <b> que se eu perdesse dinheiro </b>, ele me daria um reembolso
                    dos meus €300. Isso mostra o quão confiante ele estava de que isso
                    mudaria minha vida. Isso sim é um bom serviço ao cliente. Não me
                    surpreende os bancos estarem com medo.
                  </em>
                </p>
                <p className="text_general_content">
                  <em>
                    Uma vez que recebi acesso à The {OFFER_NAME}, depositei meu
                    investimento inicial de €300. Isso é o quanto minha família
                    gastava em comida porcaria, então paramos de ir em fast food por
                    um mês. Agora podemos ser saudáveis, e quem sabe ricos também.
                  </em>
                </p>
                <p className="text_general_content">
                  <em>
                    ...
                    software usa algoritmos avançados de AI e Machine Learning para
                    prever exatamente quando uma criptomoeda vai subir ou descer. Daí
                    ela vai automaticamente comprar e vender para você a todo momento.
                    A tecnologia já tornou nossas vidas mais fácil, então por que não
                    usar para ganhar dinheiro também?”{" "}
                  </em>
                </p>
                <h2 className="first_content_title">
                  <TelegramRedirect className="first_content_title_link_h2">
                ...
                <p className="text_general_content">
                  <em>
                    “Depois de apenas 1 hora de ter depositado os €300, o software
                    começou a tradar para mim. Para ser honesto, eu estava nervoso de
                    que ele perderia todo meu dinheiro. E claro, meu primeiro trade
                    foi uma perda de €63!
                  </em>
                </p>
                <p className="text_general_content">
                  <em>
                    Eu senti minha garganta fechando. Achei que tivesse sido enganado.
                    Eu estava até mesmo pronto para ligar para meu investidor pessoal
                    e pedir meu dinheiro de volta. Então me lembrei do que ele disse:{" "}
                    <b> O algoritmo está certo 80-89% das vezes </b>. Você não vai
                    ganhar TODA vez, mas você vai ganhar o suficiente e lucrar no
                    geral.{" "}
                  </em>
                </p>
                <TelegramRedirect>
                    <img loading="lazy"  src={Img6} alt="" className="image_responsive" />
                  </TelegramRedirect>
                <p className="text_general_content">
                  <em>
                    Então eu deixei o software continuar a tradar e fiquei de olho.{" "}
                    <b> O próximo trade teve lucro! </b> Apenas €46, mas ainda era
                    algo. Então depois <b> lucro </b> de €139. Depois mais €59, com um
                    total de lucro de €244. E tudo isso em menos de 5 minutos!
                  </em>{" "}
                </p>
                <p className="text_general_content">
                  <em>
                    Eu logo comecei a ganhar dinheiro sem parar e eu não conseguia
                    acreditar nos meus olhos. Cada vez que eu atualizava a tela, os
                    lucros eram maiores e maiores. Eu achei que estava usando drogas
                    porque isso era bem excitante.
                  </em>{" "}
                </p>
      
                <TelegramRedirect>
                  <img loading="lazy"  src={cheque} className="image_responsive" alt="" />
                </TelegramRedirect>
                <p></p>
                <center>
                  <i>
                ...
                <p className="text_general_content">
                  <em>
                    “Agora eu estou consistentemente fazendo €700 a €1,500 por dia
                    graças à
                    <TelegramRedirect className="general_links ">
                      {" "}
                      {OFFER_NAME}
                ...
                <p className="text_general_content">
                  <em>
                    ...
                    importantes para notícias (como essa) ou eu já teria saído faz
                    tempo. Eu fiz, no entanto, um plano de viagens para minha família
                    para Bali Indonésia para celebrar quitar minhas dívidas e
                    finalmente conseguir ajeitar a situação financeira da minha
                    família!
                  </em>
                </p>
                <p className="text_general_content">
                ...
                <p className="text_general_content">
                  <em>
                    ...
                    Minha esposa está mais feliz do que nunca e minhas filhas cheias
                    de brinquedos.
                  </em>
                </p>
                <p className="text_general_content">
                  <em>
                    Meus colegas de trabalho estão se batendo por não terem entrado
                    duas semanas antes como eu fiz. Mas eventualmente todo o
                    escritório se cadastrou (incluindo meu chefe) e eles estão me
                    chamando de herói.”
                  </em>
                </p>
                <h2 className="first_content_title">
                  <TelegramRedirect className="first_content_title_link_h2 title_blue">
                    COMO COMEÇAR COM A THE {OFFER_NAME} (LUGARES LIMITADOS
                    DISPONÍVEIS)
                  </TelegramRedirect>
                </h2>
                <p className="text_general_content">
                  ...
                  específica além de saber como usar um computador e usar a internet.
                  Você não precisa de nenhuma experiência tecnológica nem em
                  criptomoedas porque o software e seu investidor pessoal te garantem
                  lucro.
                </p>
                <p className="text_general_content">
                  Outro benefício desse programa é que você começa quando quiser. Você
                  pode ter sua própria agenda seja ela 5 horas por semana ou 50 horas
                  por semana. Apenas inicie o software de negociação automática quando
                  quiser, e pause quando quiser (Eu não sei por que você faria isso,
                  mas...).
                </p>
                <p className="text_general_content">
                  Para economizar o tempo do nosso leitor e verificar as
                  funcionalidades, criamos um guia de como começar.
                </p>
                <h2 className="first_content_title">
                  <TelegramRedirect className="first_content_title_link_h2">
                ...
                <p className="text_general_content">
                  ...
                  A propaganda é grande e direta ao ponto, mas é um produto Americano
                  e é assim que eles fazem as coisas. De qualquer forma,
                  <b> você simplesmente coloca seu nome e endereço de e-mail </b>{" "}
                  próximo ao vídeo para começar na hora.
                </p>
                <p className="text_general_content">
                  <em>
                    <b>(Dica: </b> Mesmo que você não decida investir dinheiro, eu te
                    recomendo <b> cadastrar agora </b>
                    porque é gratuito e cadastros para residentes Português podem
                    acabar em qualquer momento)
                    <TelegramRedirect className="general_links ">
                      {" "}
                      {OFFER_NAME}
                      {". "}
                ...
                <p>
                  <TelegramRedirect>
                    <img loading="lazy"  src={Img7} alt="" className="image_responsive" />
                  </TelegramRedirect>
                </p>
                <p className="text_general_content">
                  Depois, você precisa colocar <b> dinheiro em sua conta </b>. Quando
                  eu estava navegando pela página de depósitos, meu celular tocou. Era
                  um número internacional então eu hesitei aceitar mas depois percebi
                  de quem era.
                </p>
                ...
                <p>
                  <TelegramRedirect>
                    <img loading="lazy"  src={Img8} alt="" className="image_responsive" />
                  </TelegramRedirect>
                </p>
                <h2 className="first_content_title steps_title">
                  Passo 3:{" "}
                ...
                <p className="text_general_content">
                  ...
                  aceitam todos os cartões de crédito principais como Visa e
                  MasterCard. Eu fui e depositei a quantia mínima que era de €250.{" "}
                </p>
                <p className="text_general_content">
                  Uma vez com fundos, naveguei até a aba “Auto Trader” no software,
                  coloquei a quantidade para os €250 recomendados e habilitei. O
                  software começou a fazer trades à uma taxa rápida e eu estava
                  preocupado no começo, mas deixei ele sozinho.
                </p>
                <p className="text_general_content">
                  <em>
                ...
                <p className="text_general_content">
                  ...
                  aceita apenas uma quantidade limitada de usuários para que os lucros
                  se mantenham sempre altos. Agora, temos apenas (37) vagas abertas,
                  então se apresse e se cadastre agora para garantir seu lugar{" "}
